...
//   const collectionRef = collection(db, "codesToUse");

//   for (const codeObj of codes) {
//     const docRef = doc(collectionRef); // genera un ID automático
//     await setDoc(docRef, codeObj);
//   }

//   console.log("¡Códigos subidos correctamente!");
// }
...
async function resetClaimed() {
    ...
    for (const docSnap of snapshot.docs) {
      await updateDoc(docSnap.ref, { claimed: false });
    }
  
    console.log("¡Todos los códigos fueron reseteados!");
  }
